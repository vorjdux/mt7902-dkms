...
mt7902s_mcu_send_message(struct mt7902_mt76_dev *mdev, struct sk_buff *skb,
			 int cmd, int *seq)
{
	struct mt7902_mt7902_mt792x_dev *dev = container_of(mdev, struct mt7902_mt7902_mt792x_dev, mt76);
	 ...
	 * blocked by mt7902_mt7902_mt792x_mac_work that is excuting register access via sdio
	 * bus.
	 */
	if (dev->fw_assert)
		return -EBUSY;
