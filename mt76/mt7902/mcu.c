...
int mt7902_mcu_regval(struct mt7902_mt792x_dev *dev, u32 regidx, u32 *val, bool set)
{
				 ...
				 struct ieee80211_bss_conf *info)
{
	...
	skb = mt7902_mt76_mcu_msg_alloc(dev, NULL, sizeof(req) + len * 2 * sizeof(__be32));
	if (!skb)
		return -ENOMEM;
...
#ifdef CONFIG_PM
static int
mt7902_connac_mcu_set_wow_ctrl(struct mt7902_mt76_phy *phy, struct ieee80211_vif *vif,
...
static int
mt7902_mcu_set_wow_pattern(struct mt7902_mt76_dev *dev,
...
static void
mt7902_mcu_connection_loss_event(struct mt7902_mt792x_dev *dev, struct sk_buff *skb)
{
...
static void
mt7902_mcu_uni_roc_event(struct mt7902_mt792x_dev *dev, struct sk_buff *skb)
{
...
static void
mt7902_mcu_scan_event(struct mt7902_mt792x_dev *dev, struct sk_buff *skb)
{
	struct mt7902_mt76_phy *mphy = &dev->mt76.phy;
...
static void
mt7902_mcu_tx_done_event(struct mt7902_mt792x_dev *dev, struct sk_buff *skb)
{
...
static void
mt7902_mcu_uni_debug_msg_event(struct mt7902_mt792x_dev *dev, struct sk_buff *skb)
{
...
static void
mt7902_mcu_uni_rx_unsolicited_event(struct mt7902_mt792x_dev *dev,
				    struct sk_buff *skb)
{
	struct mt7902_mcu_rxd *rxd;
...
static int
mt7902_mcu_sta_ba(struct mt7902_mt76_dev *dev, struct mt7902_mt76_vif *mvif,
		  ...
		  bool enable, bool tx)
{
	...
	return mt7902_mt76_mcu_skb_send_msg(dev, skb,
...
int mt7902_mcu_uni_tx_ba(struct mt7902_mt792x_dev *dev,
			 ...
			 bool enable)
{
	struct mt7902_mt792x_sta *msta = (struct mt7902_mt792x_sta *)params->sta->drv_priv;
...
static void
mt7902_mcu_parse_phy_cap(struct mt7902_mt792x_dev *dev, char *data)
{
	struct mt7902_mt76_phy *mphy = &dev->mt76.phy;
...
static int
mt7902_mcu_get_nic_capability(struct mt7902_mt792x_dev *dev)
{
	struct mt7902_mt76_phy *mphy = &dev->mt76.phy;
	struct {
		u8 _rsv[4];
...
int mt7902_mcu_chip_config(struct mt7902_mt792x_dev *dev, const char *cmd)
{
	...
	return mt7902_mt76_mcu_send_msg(&dev->mt76, MCU_UNI_CMD(CHIP_CONFIG),
			     ...
			     struct ieee80211_sta *sta)
{
	...
	tlv = mt7902_mt76_connac_mcu_add_tlv(skb, STA_REC_HDR_TRANS, sizeof(*hdr_trans));
				     ...
				     struct ieee80211_sta *sta)
{
	...
	skb = __mt7902_mt76_connac_mcu_alloc_sta_req(&dev->mt76, &mvif->mt76,
					      &msta->wcid,
...
{
	struct mt7902_mt792x_sta *msta = container_of(wcid, struct mt7902_mt792x_sta, wcid);
		       ...
		       enum mt7902_roc_req type, u8 token_id)
{
	...
	return mt7902_mt76_mcu_send_msg(&dev->mt76, MCU_UNI_CMD(ROC),
				 &req, sizeof(req), false);
}
...
int mt7902_mcu_set_chan_info(struct mt7902_mt792x_phy *phy, u16 tag)
{
	...
	return mt7902_mt76_mcu_send_msg(&dev->mt76, MCU_UNI_CMD(CHANNEL_SWITCH),
				 &req, sizeof(req), true);
}
...
static int
mt7902_mcu_uni_bss_bcnft(struct mt7902_mt792x_dev *dev, struct ieee80211_vif *vif,
			 bool enable)
{
	struct mt7902_mt792x_vif *mvif = (struct mt7902_mt792x_vif *)vif->drv_priv;
	struct {
...
int
mt7902_mcu_set_bss_pm(struct mt7902_mt792x_dev *dev, struct ieee80211_vif *vif,
		      bool enable)
{
	struct mt7902_mt792x_vif *mvif = (struct mt7902_mt792x_vif *)vif->drv_priv;
	struct {
		       ...
		       struct ieee80211_vif *vif, struct ieee80211_sta *sta)
{
	...
	phy->phy_type = mt7902_mt76_connac_get_phy_mode_v2(mvif->phy->mt76, vif, chandef->chan->band, sta);
...
static void
mt7902_mcu_sta_state_v2_tlv(struct mt7902_mt76_phy *mphy, struct sk_buff *skb,
			    struct ieee80211_sta *sta,
			    struct ieee80211_vif *vif,
...
static int
mt7902_mcu_sta_cmd(struct mt7902_mt76_phy *phy,
...
int mt7902_get_txpwr_info(struct mt7902_mt792x_dev *dev, u8 band_idx, struct mt7902_txpwr *txpwr)
{
...
#define TXPOWER_ALL_RATE_POWER_INFO 0x2
	...
	ret = mt7902_mt76_mcu_send_and_get_msg(&dev->mt76, MCU_UNI_CMD(TXPOWER),
					&req, sizeof(req), true, &skb);
	if (ret)
		return ret;
			   ...
			   bool enable)
{
	...
	mt7902_mt76_mcu_send_msg(&dev->mt76, MCU_UNI_CMD(SNIFFER), &req, sizeof(req), true);

	return mt7902_mt76_mcu_send_msg(&dev->mt76, MCU_UNI_CMD(SNIFFER), &req, sizeof(req),
				 true);
}
			      ...
			      struct ieee80211_chanctx_conf *ctx)
{
	...
	return mt7902_mt76_mcu_send_msg(mphy->dev, MCU_UNI_CMD(SNIFFER),
				 &req, sizeof(req), true);
}

int
mt7902_mcu_uni_add_beacon_offload(struct mt7902_mt792x_dev *dev,
...
int mt7902_mcu_set_chctx(struct mt7902_mt76_phy *phy, struct mt7902_mt76_vif *mvif,
			 struct ieee80211_chanctx_conf *ctx)
{
...
__mt7902_mcu_alloc_bss_req(struct mt7902_mt76_dev *dev, struct mt7902_mt76_vif *mvif, int len)
{
...
static u8
mt7902_get_phy_mode_ext(struct mt7902_mt76_phy *phy, struct ieee80211_vif *vif,
			 ...
			 bool enable)
{
	...
	tlv = mt7902_mt76_connac_mcu_add_tlv(skb, UNI_BSS_INFO_BASIC, sizeof(*basic_req));
...
static void
mt7902_mcu_bss_bmc_tlv(struct sk_buff *skb, struct mt7902_mt792x_phy *phy,
		       struct ieee80211_chanctx_conf *ctx,
			   struct ieee80211_vif *vif,
			   struct ieee80211_sta *sta)
{
			 ...
			 bool enable)
{
	...
	tlv = mt7902_mt76_connac_mcu_add_tlv(skb, UNI_BSS_INFO_BSS_COLOR, sizeof(*color));
...
mt7902_mcu_bss_ifs_tlv(struct sk_buff *skb, struct ieee80211_vif *vif)
{
	...
	tlv = mt7902_mt76_connac_mcu_add_tlv(skb, UNI_BSS_INFO_IFS_TIME, sizeof(*ifs_time));
		       ...
		       struct ieee80211_scan_request *scan_req)
{
	...
	tlv = mt7902_mt76_connac_mcu_add_tlv(skb, UNI_SCAN_CHANNEL, sizeof(*chan_info));
	...
	err = mt7902_mt76_mcu_skb_send_msg(mdev, skb, MCU_UNI_CMD(SCAN_REQ),
				    false);
	if (err < 0)
			      ...
			      struct cfg80211_sched_scan_request *sreq)
{
	...
	tlv = mt7902_mt76_connac_mcu_add_tlv(skb, UNI_SCAN_SSID_MATCH_SETS, sizeof(*match));
	...
	return mt7902_mt76_mcu_skb_send_msg(mdev, skb, MCU_UNI_CMD(SCAN_REQ),
				     false);
}
EXPORT_SYMBOL_GPL(mt7902_mcu_sched_scan_req);

int
mt7902_mcu_sched_scan_enable(struct mt7902_mt76_phy *phy,
			     struct ieee80211_vif *vif,
			     bool enable)
{
	struct mt7902_mt76_dev *mdev = phy->dev;
	...
	tlv = mt7902_mt76_connac_mcu_add_tlv(skb, UNI_SCAN_SCHED_ENABLE, sizeof(*req));
			      ...
			      struct ieee80211_vif *vif)
{
	...
	return mt7902_mt76_mcu_send_msg(phy->dev, MCU_UNI_CMD(SCAN_REQ),
				 &req, sizeof(req), false);
}
...
static int
__mt7902_mcu_set_clc(struct mt7902_mt792x_dev *dev, u8 *alpha2,
...
static void
mt7902_mcu_build_sku(struct mt7902_mt76_dev *dev, s8 *sku,
...
static int
mt7902_mcu_rate_txpower_band(struct mt7902_mt76_phy *phy,
			     enum nl80211_band band)
{
