...
void __mt7902_mt76_dma_queue_reset(struct mt7902_mt76_dev *dev,
                                   struct mt7902_mt76_queue *q, bool reset_idx);
void mt7902_mt76_dma_queue_reset(struct mt7902_mt76_dev *dev,
                                 struct mt7902_mt76_queue *q);

static inline void mt7902_mt76_dma_reset_tx_queue(struct mt7902_mt76_dev *dev,
                                                  struct mt7902_mt76_queue *q) {
...
static inline void mt7902_mt76_dma_should_drop_buf(bool *drop, u32 ctrl,
                                                   u32 buf1, u32 info) {
  if (!drop)
    return;
